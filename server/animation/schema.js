  ...
  beats: z
    .array(
      z.object({
        ...
        pauseAfter: number.min(0).max(10).default(0),
      }),
    )
    .min(1)
    .max(8),
...
Beats: {id,narration,seconds,pauseAfter}; narration is synthesized per beat, giving real audio boundaries. Scene narration MUST equal beat narrations joined with spaces. Group narration around a meaningful explanatory change. seconds is a minimum, never truncate speech; pauseAfter adds 0–10 seconds of processing time after speech.
