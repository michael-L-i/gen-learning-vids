...
export async function renderBrowserScenes({
  ...
  await build({
    ...
    nodePaths: [modules],
    alias: {
      "@lesson-library/inspection": fileURLToPath(
        new URL("../inspection/index.js", import.meta.url),
      ),
      "@lesson-library/physics": fileURLToPath(
        new URL("../physics/index.js", import.meta.url),
      ),
      "@lesson-library/math": fileURLToPath(
        new URL("../math/index.js", import.meta.url),
      ),
      "@lesson-library/circuits": fileURLToPath(
        new URL("../circuits/index.js", import.meta.url),
      ),
      "@lesson-library/waves": fileURLToPath(
        new URL("../waves/index.js", import.meta.url),
      ),
      "@lesson-library/statistics": fileURLToPath(
        new URL("../statistics/index.js", import.meta.url),
      ),
      "@lesson-library/algorithms": fileURLToPath(
