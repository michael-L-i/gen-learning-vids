...
2. In **Sources & notes → Add a source**, choose a file, folder, Obsidian vault, pasted text, ChatGPT memory, or chat export. Folder imports let you preview and select individual notes; memory is pasted manually, not synced from your account.
